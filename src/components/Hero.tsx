  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100svh-8rem)] flex flex-col gap-0 row-start-2 items-center justify-center sm:items-start relative z-20 pb-12">
          ...
          {hasSubscribed && (
            <div className="flex flex-col items-center justify-center gap-0 mb-36">
              <p className="w-84 sm:w-96 mx-auto">
                We&apos;re building a hardware business in 90 days, and
                we&apos;re building it{" "}
        ...
        >
          <p>
            If you&apos;re an entrepreneur, aspiring to be one, or just excited
            to watch a business get launched 100% PUBLICLY & QUICKLY, you need
            to join our 90 Day Launch community. Here&apos;s what you can expect
            EVERY MONTH.
          </p>
          <ul className="list-disc list-inside">
            <li>
